...
csl: [https://www.zotero.org/styles/apa](https://www.zotero.org/styles/apa)
link-citations: true
colorlinks: true
...
**Target:** `fire_occurred`. This frames the problem as binary classification, which is the most natural formulation for susceptibility mapping and aligns with the majority of the literature.
